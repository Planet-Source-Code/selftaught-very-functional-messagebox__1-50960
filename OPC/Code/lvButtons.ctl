...
Private Type ButtonProperties
    ...
    bValue As Boolean
    bCustomClick As CustomClickConstants
End Type
...
Public Enum HoverLockConstants      ' hover lock options
    ...
    lv_NoLocks = 3
End Enum
Public Enum CustomClickConstants
    lv_cDefault = 0
    lv_cNorth = 1
    lv_cNorthEast = 2
    lv_cNorthWest = 3
...
Public Property Let CustomClick(nOpt As CustomClickConstants)
...
End Property
Public Property Get CustomClick() As CustomClickConstants
